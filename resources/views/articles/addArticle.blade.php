            ...
            <div class="card-body">
                ...
                <form method="POST">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" name="status" class="form-control" placeholder="Todo current status"
                            required>
                    </div>
                    <div class="form-group mt-2">
                        <label>Author</label>
                        <input type="text" name="author" class="form-control" placeholder="Todo current status"
                            required>
                    </div>
                    <div class="form-group mt-2">
